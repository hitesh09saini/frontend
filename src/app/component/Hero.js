...
const Hero = () => {
    ...
    return (
        <div className="min-h-screen box z-0 relative  pt-[60px] flex justify-center items-center " >
            <h1 title="full-stack developer" className={`text-[10vw]  drop-shadow-2xl relative ${macondo.className}  `}><span className="text-[3vw] absolute top-0 left-[-30px] "> {text}</span>
